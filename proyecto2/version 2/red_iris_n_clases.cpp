...
//      fscanf("%lf,%lf,%lf,%s"",&caso[1],&caso[2],&caso[3],&caso[4],tipo);
      ...
      if(tipo[5]=='s')
  	    respuestas.push_back(1),respuestas2.push_back(0),respuestas3.push_back(0);
  	  else if(tipo[6]=='e'){
  	    respuestas.push_back(0),respuestas2.push_back(1),respuestas3.push_back(0);
  	    }
  	  else{
  	    respuestas.push_back(0),respuestas2.push_back(0),respuestas3.push_back(1);
  	    }
